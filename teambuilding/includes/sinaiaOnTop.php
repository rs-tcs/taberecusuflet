...
$db = new Database();
					...
					// verificarea datelor ce vin din pagina "inscriere_competitie" optiunea On Top of The World
					if(isset($_POST['sinaia_on_top'])){
				 
				
								 // se verifica daca exista o competitie selectata				 
								 ...
								 // se verifica daca este selectat un traseu	
								 if(($_POST['traseu']) !== ""){
									...
									// verifica daca optiunea vip este selectata				  
								   ...
								   if($date['pachet_vip'] == "vip"){
										 ...
										 // se verifica daca marimea tricoului este selectata cand optiunea vip este bifata (obligatoriu)
										 if(($_POST['tricou']) !== ""){
								   ...
								   else
								   {
									...
									// se verifica daca optiunea de personalizare a numarului este completata (atunci cand este activa)	 
									...
									// prelucrarea datelor daca checkbox-ul confirma plata este bifat									
							 ...
							 // stabilirea traseelor si a categoriilor de varsta ce sunt permise
							 $easy_ride = array('piticoti','pitici','copii','spiridusi','uriasi','tineri','adulti','seniori','forever_young');
							 $hobby_ride = array ('tineri','adulti','seniori','forever_young');
							 $profi_ride = array('tineri','adulti','seniori','forever_young');
							 $elite_ride = array('tineri','adulti','seniori','forever_young');
							 
							 switch ($date['traseu']){
								 
								 case "Easy Ride":
								 if(in_array($categorie_varsta, $easy_ride)){
										$date['traseu'] = "Easy Ride"; 
									 }
									 else
									 {
								 ...
								 break;
								 case "Hobby Ride":
								 if(in_array($categorie_varsta, $hobby_ride)){
										$date['traseu'] = "Hobby Ride"; 
									 }
									 else
									 {
										 $error[] = "Vârsta nu îți permite să participi la acest traseu";
								 ...
								 break;
								 case "Profi Ride":
								 if(in_array($categorie_varsta, $profi_ride)){
										$date['traseu'] = "Profi Ride"; 
									 }
									 else
									 {
										 $error[] = "Vârsta nu îți permite să participi la acest traseu";
								 ...
								 break;
								 case "Elite Ride":
								 if(in_array($categorie_varsta, $elite_ride)){
										$date['traseu'] = "Elite Ride"; 
									 }
									 else
									 {
										 $error[] = "Vârsta nu îți permite să participi la acest traseu";
					 ...
					 if(!isset($error)){
										...
										if(is_array($date)){
												...
												if($result){
													...
													$subject = "Te-ai inscris cu succes la competitia"." ".$_POST['flag'];
														...
														$comp = $_POST['flag']; // competitia la care se inscriu concurentii
														$traseu = $date['traseu'];// traseul la care s-au inscris concurentii
													   ...
													   $body_message = preg_replace_callback('/{\$([^}]+)}/',function ($i) {
														...
														$result_mail = $mail->send();
														  ...
														  header("Location: ../tabel_inscriere_competitie_sinaia.php?succes=".$mesaj."&tip_comp=On Top of the World");
														  }
														  else
														  {
			  		...
			  		if(isset($error)){
						...
						header("Location: ../tabel_inscriere_competitie_sinaia.php?eroare=".$err."&tip_comp=On Top of the World");
