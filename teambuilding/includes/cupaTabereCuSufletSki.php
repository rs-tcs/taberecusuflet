...
$db = new Database();
			...
			if(isset($_POST['cupa_tabere_ski'])){
				 ...
				 // procesarea datelor specifice curieratului
					...
					$result = $db->execute($query);
					 ...
					 if(!isset($error)){
						...
						$date['email'] = $email;
							...
							// pentru Cupa 1 Martie la schi nu se proceseaza taxa
							if($_POST['flag'] !== "Ski Indoor"){
							
								// se introduce in tabel in dreptul taxei automat neachitat
						...
						$date['data_competitiei'] = $row['data_competitiei'];
								...
								if($result){
									...
									if($result_mail){
										...
										if($_POST['flag'] == "Cupa Tabere cu Suflet Ski/Snowboard"){	
					     				header("Location: ../tabel_inscriere_competitie_ski.php?succes=".$mesaj."&tip_comp=Cupa Tabere cu Suflet Ski/Snowboard");
										}
										else if($_POST['flag'] == "Ski Indoor"){
										header("Location: ../tabel_inscriere_competitie_ski.php?succes=".$mesaj."&tip_comp=Ski Indoor");	
										}
									  }
									  else
									  {
					...
					// procesarea erorilor
			  		if(isset($error)){
						...
						header("Location: ../tabel_inscriere_competitie_ski.php?eroare=".$err."&tip_comp=".$_POST['flag']);
