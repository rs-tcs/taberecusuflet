...
$db = new Database();
			...
			// verificarea datelor ce vin din pagina "inscriere_competitie" optiunea Cupa Veseliei run Fest
			 if(isset($_POST['runFestVeseliei']) && ($_POST['runFestVeseliei'] == 'ok')){				
					 ...
					 if(!isset($error)){
						...
						if($date['traseu'] == "Crosul Copiilor"){
						 		...
						 		if(is_array($date)){
										...
										if($result){
											...
											$mesaj = "Te-ai înscris cu succes în competiția"." ".ucfirst(str_replace("_"," ",$tabel));			
					     					...
					     					header("Location: ../tabel_inscriere_competitie_alergare_veseliei.php?succes=".$mesaj."&tip_comp=".$_POST['flag']);
											}
									  else
									  {
					...
					header("Location: ../tabel_inscriere_competitie_alergare_veseliei.php?eroare=".$err."&tip_comp=".$_POST['flag']);
