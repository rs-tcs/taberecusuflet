...
$db = new Database();
			...
			//inregistrare concurent in competitia Cupa Tabere cu Suflet la escalada		
			if(isset($_POST['cupa_tabere_catarat'])){
				 ...
				 // procesarea datelor specifice curieratului
					...
					$result = $db->execute($query);
					 ...
					 if(!isset($error)){
						...
						if($_POST['flag'] <> "Cupa Tabere cu Suflet la Escalada"){
						...
						$date['data_competitiei'] = $row['data_competitiei'];
								...
								if($result){
									...
									if($result_mail){
										...
										if($_POST['flag'] == "Cupa Tabere cu Suflet la Escalada"){	
					     				header("Location: ../tabel_inscriere_competitie_alpinism.php?succes=".$mesaj."&tip_comp=Cupa Tabere cu Suflet la Escalada");
										}
					...
					// procesarea erorilor
			  		if(isset($error)){
						...
						header("Location: ../tabel_inscriere_competitie_alpinism.php?eroare=".$err."&tip_comp=".$_POST['flag']);
