<?php
class TextHelper extends GummHelper {
	...
	public function getClean($text) {
		$text = preg_replace("'\[gallery.*\]'iUms", '', $text);
		$text = preg_replace("'<img.*/>'iUms", '', $text);
 ...
 * @access public
 * @link https://book.cakephp.org/view/1469/Text#truncate-1625
 */
