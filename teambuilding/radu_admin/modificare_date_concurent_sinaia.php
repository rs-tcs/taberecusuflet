                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_sinaia.php?tabelid=<?php echo $_GET['table_name'];?>&flag=<?php echo $_GET['flag']; ?>">Detalii Tabel Competiții</a>&nbsp;&nbsp;>></li>
                            <li class="active">Modifică date concurent</li>
                        </ul>                    
                   </div>
                    <br>
                    <?php
					if(isset($_GET['err'])){$eroare = base64_decode($_GET['err']); echo "<div class=\"eroare\"><img src=\"pics/cross1.png\" />{$eroare}</div><br>";}
					?>
                    <table id="tabel_competitie" cellpadding="2px" cellspacing="2px" >
									...
									if($result){
                                     ...
                                     <tr>
                                         ...
                                         <select name="traseu">
												...
												$query = "SELECT `traseu` FROM `traseu_sinaia_ontop` WHERE 1 ";
												$result = $db->execute($query);
							...
							?>
                            		<tr class="celule">
                                    	...
                                    	<input type="hidden" name="modifica_date_concurent_sinaia" value="ok" />
