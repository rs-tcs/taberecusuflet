                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_bikefest.php?tabelid=<?php echo $_GET['tbl_name'];?>&coloana=<?php if(( $_GET['coloana']) <> ""){echo $_GET['coloana'];}else{echo "id";};?>&pagina=<?php if(isset($_GET['pagina']) <> ""){echo $_GET['pagina'];}else{echo 1;}?><?php if(isset($_GET['flag'])){ echo "&flag=".$_GET['flag'];}?>">Detalii Tabel Competiție</a>&nbsp;&nbsp;>></li>
                    ...
                    <table id="tabel_competitie" cellpadding="2px" cellspacing="2px" >
                    		...
                    		<tr >
                            	<td class="cap_tabel" colspan="19" style="font-size:14px">Modifică detalii tabel "<?php echo $_GET['tbl_name'];?>"</td>
                    		</tr>
                    		<tr class="cap_coloana">
								...
								if(isset($_GET['flag']) && ($_GET['flag'] == "Cupa Tabere cu Suflet")){ 
									// se afiseaza optiunea duatlon pentru competitia Cupa Tabere cu Suflet
								?>
								<td>Duatlon</td>	
								<?php	
								}
                                ...
                                <?php
								if(isset($_GET['flag']) && ($_GET['flag'] == "Cupa 1 Iunie")){
									// aceasta coloana nu se afiseaza pentru competitia Cupa 1 Iunie
								}
								else
								{
								?>
                            ...
                            <?php
								if(isset($_GET['tbl_name'])){
                                   ...
                                   <tr class="celule">     
										<td style="width:25px"><input type="text" name="id[]"
                                        ...
                                        <td  style="width:30px"><input type="text" name="insotitor[]" 
                                        value="<?php echo $row['insotitor'];?>" />
                                        </td>
                                        <?php
										if(isset($_GET['flag']) && ($_GET['flag']== "Cupa 1 Iunie")){
										// pentru competitia Cupa 1 Iunie nu se afiseaza detalii vip	
                                        ...
                                        <?php
										} // sfarsit informatii despre pachet vip
										?>
                                        <?php
										if(isset($_GET['flag']) && ( $_GET['flag'] == "Cupa Tabere cu Suflet")){
											// se afiseaza optiunea duatlon pentru Cupa Tabere cu Suflet 
										?>
										<td style="width:40px"><input type="text" name="duatlon[]" 
                                        value="<?php echo $row['duatlon'];?>" />
                                        </td>												
										 <?php
										 	}
										?>
							...
							?>
                            		...
                            		<tr style="text-align:center">
                                    	...
                                    	<input type="hidden" name="modifica_competitie" value="ok" />
                                        <input type="hidden" name="modifica_competitie_tabel" value="<?php echo $_GET['tbl_name'];?>" />                                      <input type="hidden" name="coloana" value="<?php echo $_GET['coloana'];?>" /> 
