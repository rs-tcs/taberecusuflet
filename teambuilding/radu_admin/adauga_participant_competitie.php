                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_bikefest.php?tabelid=<?php echo $_GET['tbl_name'];?><?php if(isset($_GET['flag'])){echo "&flag=".$_GET['flag'];}?>">Detalii Tabel Competiție</a>&nbsp;&nbsp;>></li>
                    ...
                    <table id="tabel_participant" cellpadding="2px" cellspacing="2px">
                    		...
                    		<form action="update.php" method="post" >
                                ...
                                <tr>
									...
									if($_GET['flag'] == 'Cupa 1 Iunie') {
										
									$query = "SELECT `categorii` FROM `cat_varsta` WHERE 1 LIMIT 5";
                                ...
                                <tr>
                                       ...
                                       <td class="celule"><select name="traseu">
                                       			<option value="">Alege traseul</option>                               
                                       					  
                                    <?php
									if($_GET['flag'] == 'Cupa 1 Iunie'){
									?>
									<option value="Copiilor">Traseul Copiilor</option>	
									<?php
                                    }
									else if($_GET['flag'] == 'Cupa Veseliei'){
									?>
                                    <option value="Copiilor">Traseul Copiilor</option>
                                    <option value="Veseliei">Traseul Veseliei</option>                                    
                                    <?php										
									}
									else
									{
									...
									$traseul = $db->execute($query);
									if(mysqli_num_rows($traseul) > 1){
										while($row = mysqli_fetch_array($traseul)){
									
											echo "<option value='{$row['traseul']}'>{$row['traseul']}</option>"; 
										}
									}
									}
                                ...
                                <tr>
                                       ...
                                       <td class="celule"><input type="checkbox" name="insotitor" value="da"/></td>                               
                                ...
                                <?php
								} // sfarsit informatii vip pentru Cupa 1 Iunie
								?>
                                <?php
									if(isset($_GET['flag']) && ($_GET['flag'] == "Cupa Tabere cu Suflet")){?>
								<tr>
                                	   <td class="cap_tabel">Participant Duatlon ?</td>
                                       <td class="celule"><input type="checkbox" name="duatlon" value="duatlon"/></td>
                                </tr>		
                                ...
                                <?php
								if(isset($_GET['flag']) && ($_GET['flag'] == "Cupa 1 Iunie")){
									// nu se afiseaza taxa pentru Cupa 1 Iunie
								}
								else
								{
								?>
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" name="tabel_competitie" value="<?php echo $_GET['tbl_name']; ?>" />
