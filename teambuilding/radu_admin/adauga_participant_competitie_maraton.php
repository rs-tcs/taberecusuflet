                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_maraton.php?tabelid=<?php echo $_GET['tbl_name'];?>&flag=<?php echo $_GET['flag']?>">Detalii Tabel Competiție</a>&nbsp;&nbsp;>></li>
                    ...
                    <table id="tabel_participant" cellpadding="2px" cellspacing="2px">
                    		...
                    		<form action="update.php" method="post" >
                                ...
                                <tr>
                                        ...
                                        <td class="celule"><input type="checkbox" name="duatlon" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" name="tabel_competitie_maraton" value="<?php echo $_GET['tbl_name']; ?>" />
