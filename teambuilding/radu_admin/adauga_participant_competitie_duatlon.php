                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_duatlon.php?tabelid=<?php echo $_GET['tbl_name'];?>&flag=<?php if(isset($_GET['flag'])){echo $_GET['flag'];}?>">Detalii Tabel Competiție</a>&nbsp;&nbsp;>></li>
                    ...
                    <table id="tabel_participant" cellpadding="2px" cellspacing="2px">
                    		...
                    		<form action="update.php" method="post" >
                                ...
                                <tr>
                                       ...
                                       <td class="celule"><select name="traseu_alergare">
									...
									if(mysqli_num_rows($traseul) > 1){
										while($row = mysqli_fetch_array($traseul)){
											...
											echo "<option value='{$row['traseu']}'>{$row['traseu']}</option>"; 
										}
									}
                                ...
                                <tr>
                                       <td class="cap_tabel">Traseu bicicleta*</td>
                                       <td class="celule">
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" name="tabel_competitie_duatlon" value="<?php echo $_GET['tbl_name']; ?>" />
