                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_maraton.php?tabelid=<?php echo $_GET['table_name'];?>&flag=<?php echo ($_GET['flag']);?>">Detalii Tabel Competiții</a>&nbsp;&nbsp;>></li>
                    ...
                    <table id="tabel_competitie" cellpadding="2px" cellspacing="2px" >
                            ...
                            <?php
								if((isset($_GET['comp_id'])) && (isset($_GET['table_name']))){
									...
									<?php if($row['traseu'] == $traseu['traseu']){ ?> selected="selected" <?php } ?>>
									<?php echo $traseu['traseu'] ;?>
                                     ...
                                     <tr>
                                     	<td class="cap_tabel">Participare Duatlon</td>
                                        <td class="celule"><input type="text" name="duatlon" value="<?php echo $row['duatlon']?>"/></td>
                                     </tr>
                                     <tr>
							...
							?>
                            		<tr class="celule">
                                    	...
                                    	<input type="hidden" name="modifica_date_concurent_maraton" value="ok" />
