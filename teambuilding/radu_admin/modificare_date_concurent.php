                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_bikefest.php?tabelid=<?php echo $_GET['table_name'];?><?php if(isset($_GET['flag'])){ echo "&flag=".$_GET['flag'];}else{echo "";}?>">Detalii Tabel Competiții</a>&nbsp;&nbsp;>></li>
                    ...
                    <?php
						if(isset($_GET['eroare'])){
							$eroare = base64_decode($_GET['eroare']);
							
							echo "<div class=\"eroare\"><img src=\"pics/cross1.png\" />{$eroare}</div><br>";
                    ...
                    <table id="tabel_competitie" cellpadding="2px" cellspacing="2px" >
                            ...
                            <?php
								if((isset($_GET['comp_id'])) && (isset($_GET['table_name']))){
									...
									if($result){
                                     ...
                                     <tr>
                                     	 <td class="cap_tabel">Traseu</td>
                                     	 <td class="celule">
                                         <select name="traseu">
                                         <option value="">Alegeți traseul</option>
                                         		<?php
												if($_GET['flag'] == 'Cupa Veseliei'){
													
												$query = "SELECT `traseul` FROM `traseu_veseliei` WHERE 1 ";
												$result = $db->execute($query);
												
													while($traseu = $db->getObject($result)){ 
													?>
													<option value="<?php echo $traseu['traseul'] ;?>" 
													<?php if($row['traseu'] == $traseu['traseul']){ ?> selected="selected" <?php } ?>>
									...
									else
									{
                                     ...
                                     <tr>
                                     	...
                                     	<td class="celule">
                                        <select name="tricou">
                                        <option value="">Fara tricou</option>
                                        <?php
                                     ...
                                     <?php
									} // sfarsit informatii vip
									 ?>
                                     <?php
									 if(isset($_GET['flag']) && ($_GET['flag']== "Cupa Tabere cu Suflet")){ ?>
										
                                      <tr>
                                     	<td class="cap_tabel">Duatlon</td>
                                        <td class="celule" style="text-align:left">
                                         <?php 
                                         	if($row['duatlon'] == "duatlon"){ ?>
												
												<input type="checkbox" name="duatlon" checked value="duatlon" />
											<?php
												}
												else
												{
											?>	
												...
												<input type="checkbox" name="duatlon" value="" />	
                                     ...
                                     <?php
									 if(isset($_GET['flag']) && ($_GET['flag']== "Cupa 1 Iunie")){
										// acest camp nu se afiseaza cand competitia este Cupa 1 Iunie 
									 }
									 else
									 {
									 ?>
                                     <tr>
                                    	 <td class="cap_tabel">Ture</td>
                                     	 <td class="celule"><input type="text" name="ture"
                                         value="<?php echo $row['ture'];?>" />
                                         </td>
                                     </tr>
                                     <?php
									 }
                                     ...
                                     <tr>
                                     	<td class="cap_tabel">Telefon</td>
                                     	<td class="celule"><input type="text" name="telefon" 
                                        value="<?php echo $row['telefon'];?>" />
                                        </td>
                                     </tr>
                                     <?php
									 if(isset($_GET['flag']) && ($_GET['flag']== "Cupa 1 Iunie")){
										// aceste campuri nu se afiseaza cand competitia este Cupa 1 Iunie 
									 }
									 else
									 {
									 ?>
							...
							?>
                            		<tr class="celule">
                                    	...
                                    	<input type="hidden" name="modifica_date_concurent" value="ok" />
                                        <input type="hidden" name="nume_tabel" value="<?php echo $tabel; ?>" />
                                        <input type="hidden" name="id_concurent" value="<?php  echo $concurent; ?>" />
                                        <input type="hidden" name="flag" value="<?php if(isset($_GET['flag'])){echo $_GET['flag'];}else{echo "";} ?>" />                                      
                                   			 </td>
                               		 </tr>
