                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_maraton.php?tabelid=<?php echo $_GET['tbl_name'];?>&coloana=<?php if(( $_GET['coloana']) <> ""){echo $_GET['coloana'];}else{echo "id";};?>&pagina=<?php if(isset($_GET['pagina']) <> ""){echo $_GET['pagina'];}else{echo 1;}?>&flag=<?php echo $_GET['flag'];?>">Detalii Tabel Competiție</a>&nbsp;&nbsp;>></li>
                    ...
                    <table id="tabel_competitie" cellpadding="2px" cellspacing="2px" >
                            ...
                            <?php
								if(isset($_GET['tbl_name'])){
                                   ...
                                   <tr class="celule">     
                                		...
                                		<td style="width:55px"><input type="text" name="cod[]" 
                                        value="<?php echo $row['cod_unic_participant'];?>"  readonly/>
                                        </td>
                               			<td style="width:100px"><input type="text" name="numele[]" 
                                        value="<?php echo $row['numele'];?>" />
                                        </td>
                              			<td style="width:100px"><input type="text" name="prenumele[]"
                                        ...
                                        value="<?php echo $row['sex'];?>" />
                              			...
                              			<td style="width:70px"><input type="text" name="traseu[]"
							...
							?>
                            		...
                            		<tr style="text-align:center">
                                    	...
                                    	<input type="hidden" name="modifica_competitie_maraton" value="ok" />
