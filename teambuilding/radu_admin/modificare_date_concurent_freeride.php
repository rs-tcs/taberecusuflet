                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_freeride.php?tabelid=<?php echo $_GET['table_name'];?>&flag=<?php echo $_GET['flag']; ?>">Detalii Tabel Competiții</a>&nbsp;&nbsp;>></li>
					...
					if(isset($_GET['err']))
					{
						$eroare = unserialize(base64_decode($_GET['err']));
						echo "<div class=\"eroare\" style=\"text-align:left\">";
							foreach($eroare as $error){
                    ...
                    <table id="tabel_competitie" cellpadding="2px" cellspacing="2px" >
                            ...
                            <?php
								if((isset($_GET['comp_id'])) && (isset($_GET['table_name']))){
									...
									if($result){
                                     ...
                                     <tr>
                                     	 <td class="cap_tabel">Categorie competiție</td>
                                     	 <td class="celule">
                                         <select name="categoria">                  
                                         	<option value="">Selectează categorie competiție</option>                                            
                                         	<option value="schi" <?php if($row['categoria'] == "schi") echo "selected"; ?>>Schi</option>
                                            <option value="snowboard" <?php if($row['categoria'] == "snowboard") echo "selected"; ?>>Snowboard</option>
                                         </select>                                        
                                         
                                         </td>
                                     </tr>
                                     <tr>
                                     		<td class="cap_tabel">Adresa persoană de contact</td>
                                            <td class="celule"><textarea name="adresa"><?php echo $row['adresa']; ?></textarea></td>
                                     </tr>
                                     <tr>
                                     		<td class="cap_tabel">Aveți experiență freeride ?</td>
                                            <td class="celule">
                                            <textarea name="experienta"><?php echo $row['experienta'];?></textarea>                                           </td>
                                     </tr>                                     
                                     <tr>
                                     ...
                                     <tr>
                                      ...
                                      <tr>
                                    	 <td class="cap_tabel">Total</td>
                                     	 <td class="celule"><input type="text" name="total"
									...
									<option value="<?php echo $rand['val_modalitate'] ;?>" <?php if($row['modalitate_plata'] == $rand['val_modalitate']){?>selected="selected"<?php }?>><?php echo $rand['tip_plata'];?></option>			
                                     ...
                                     <tr>
                                        ...
                                        value="<?php echo $row['data_competitiei'];?>" readonly/>
                                        </td>		
                                     </tr>                      
							...
							?>
                            		<tr class="celule">
                                    	...
                                    	<input type="hidden" name="modifica_date_concurent_freeride" value="ok" />
