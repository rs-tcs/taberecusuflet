                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_freeride.php?tabelid=<?php echo $_GET['tbl_name'];?>&coloana=<?php if(( $_GET['coloana']) <> ""){echo $_GET['coloana'];}else{echo "id";};?>&pagina=<?php if(isset($_GET['pagina']) <> ""){echo $_GET['pagina'];}else{echo 1;}?>&flag=<?php echo $_GET['flag'];?>">Detalii Tabel Competiție</a>&nbsp;&nbsp;>></li>
                    ...
                    <table id="tabel_competitie" cellpadding="2px" cellspacing="2px" >
                    		...
                    		<tr class="cap_tabel">
                            	<td colspan="19" style="font-size:14px">Modifică detalii tabel "<?php echo $_GET['tbl_name'];?>"</td>
                    		</tr>
								...
								if(isset($_GET['tbl_name'])){
                                   ...
                                   <tr class="celule">     
                                        ...
                                        value="<?php echo $row['cod_unic_participant'];?>"  readonly/>
                               			...
                               			<td style="width:70px"><input type="text" name="numele[]" 
                                        value="<?php echo $row['numele'];?>" />
                                        </td>
                              			<td style="width:70px"><input type="text" name="prenumele[]"
                                        ...
                                        value="<?php echo $row['sex'];?>"/>
                              			...
                              			<td style="width:55px"><input type="text" name="categoria[]"
                                         value="<?php echo $row['categoria'];?>" />
                                        </td>
                                        <td style="width:120px"><input type="text" name="experienta[]"
                                         value="<?php echo $row['experienta'];?>"  />
                                        </td>
                                        <td style="width:150px"><input type="text" name="adresa[]"
							...
							?>
                            		...
                            		<tr style="text-align:center">
                                    	...
                                    	<input type="hidden" name="modifica_competitie_freeride" value="ok" />
