                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                            ...
                            <li><a href="detalii_tabel_competitie_duatlon.php?tabelid=<?php echo $_GET['tbl_name'];?>&coloana=<?php if(( $_GET['coloana']) <> ""){echo $_GET['coloana'];}else{echo "id";};?>&pagina=<?php if(isset($_GET['pagina']) <> ""){echo $_GET['pagina'];}else{echo 1;}?>&flag=<?php echo $_GET['flag']; ?>">Detalii Tabel Competiție</a>&nbsp;&nbsp;>></li>
                    ...
                    <table id="tabel_competitie" cellpadding="2px" cellspacing="2px" >
                    		...
                    		<tr class="cap_tabel">
                            	<td colspan="21" style="font-size:14px">Modifică detalii tabel "<?php echo $_GET['tbl_name'];?>"</td>
                    		</tr>
								...
								if(isset($_GET['tbl_name'])){
                                   ...
                                   <tr class="celule">     
                                        ...
                                        value="<?php echo $row['sex'];?>" />
                              			...
                              			<td style="width:70px"><input type="text" name="traseu_alergare[]"
                                         value="<?php echo $row['traseu_alergare'];?>" />
                                        </td>
                                        <td style="width:70px"><input type="text" name="traseu_bicicleta[]"
                                         value="<?php echo $row['traseu_bicicleta'];?>" />
                                        </td>
                                        <td style="width:25px"><input type="text" name="insotitor[]" 
                                        ...
                                        value="<?php echo $row['puncte'];?>" />
                              			...
                              			<td style="width:50px"><input type="text" name="timp_bicicleta[]"
                                         value="<?php echo $row['timp_bicicleta'];?>" />
                                        </td>
                                        <td style="width:50px"><input type="text" name="timp_alergare[]"
                                         value="<?php echo $row['timp_alergare'];?>" />
                                        </td>
                                        <td style="width:50px"><input type="text" name="timp[]"
                                         value="<?php echo $row['timp'];?>" />
                                        </td>
                                         <td style="width:50px"><input type="text" name="dificultate[]"
							...
							?>
                            		...
                            		<tr style="text-align:center">
                                    	...
                                    	<input type="hidden" name="modifica_competitie_duatlon" value="ok" />
