			...
			<div id="page">
                ...
                <div id="meniu_stanga">
                 ...
                 <div class="main_content">	
                  ...
                  <div id="admin">
                    ...
                    <div id="breadcrumbs">
                    	<ul>
                        	<li><a href="clasament_general.php">Tabele competiții </a>&nbsp;&nbsp;>></li>
                            <li><a href="detalii_clasament_general.php?tabel=<?php echo $_GET['tabel'];?><?php if(isset($_GET['pagina']) <> ""){echo "&pagina=".$_GET['pagina'];}?>&gen=<?php echo $_GET['gen'];?><?php echo (isset($_GET['sex'])? "&sex=".$_GET['sex'] : "")?>">Detalii Tabel Competiție</a>&nbsp;&nbsp;>></li>
                    ...
                    <table id="tabel_competitie" cellpadding="2px" cellspacing="2px" >
                    		...
                    		<tr class="cap_tabel">
                            	<td colspan="10" style="font-size:14px">Modifică detalii tabel "<?php echo $_GET['tabel'];?>"</td>
                    		</tr>
                            ...
                            <?php
								if(isset($_GET['tabel'])){
									...
									if(isset($_GET['sex'])){
									$query = "SELECT * FROM `".$tabel."` WHERE `sex` = '".$_GET['sex']."' ORDER BY id asc LIMIT $start, $afisari_pagina";	
									}
                                   ...
                                   <tr class="celule">     
                                		...
                                		<td ><input type="text" name="cod_unic[]" 
                                        ...
                                        value="<?php echo $row['categoria'];?>" />
                              			...
                              			<td ><input type="text" name="locul[]"
                                         value="<?php echo $row['locul'];?>"/>
                                        </td>
                                        <td ><input type="text" name="rezultat[]" 
                                        value="<?php echo $row['rezultat'];?>"  />
                                        </td>
                               			<td style="width:450px" ><input type="text" name="competitii[]" 
                                        value="<?php echo $row['competitii'];?>" style="text-align:left; width:450px" />
                                        </td>
                                        <td ><input type="text" name="participari[]" 
                                        value="<?php echo $row['participari'];?>" />
                                        </td>                                        
							...
							?>
                            		...
                            		<tr style="text-align:center">
                                    	...
                                    	<input type="hidden" name="modifica_clasament_general" value="ok" />
                                        <input type="hidden" name="modifica_clasament_tabel" value="<?php echo $_GET['tabel'];?>" />                                        <input type="hidden" name="start" value="<?php echo $start;?>" /> 
                                        <input type="hidden" name="gen" value="<?php if(isset($_GET['gen'])){echo $_GET['gen'];};?>" /> 
				...
				echo ($x == $pagina) ? '<div id="strong"><a href="?pagina='.$x.'&tabel='.$_GET['tabel'].'&gen='.$_GET['gen'].'" >'.$x.'</a></div>'
                        		 : '<a href="?pagina='.$x.'&tabel='.$_GET['tabel'].'&gen='.$_GET['gen'].'">'.$x.'</a> ';
															...
															{
				echo ($x == $pagina) ? '<div id="strong"><a href="?pagina='.$x.'&tabel='.$_GET['tabel'].'&gen='.$_GET['gen'].'&sex='.$_GET['sex'].'" >'.$x.'</a></div>'
                        		 : '<a href="?pagina='.$x.'&tabel='.$_GET['tabel'].'&gen='.$_GET['gen'].'&sex='.$_GET['sex'].'">'.$x.'</a> ';												
															}
																?>
				   												</div>
																<?php
