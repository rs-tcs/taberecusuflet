/*
	...
	by Yukio Arita (https://homepage.mac.com/yukikun/software/slimbox_ex/)
...
var Lightbox = {
	init: function(options){
		this.options = Object.extend({
			...
			initialHeight: 250,
			animateCaption: true,
			defaultIframeWidth : 640, 
			defaultIframeHeight: 352
		}, options || {});
	...
	nextEffect: function(){
		...
		case 1:
			...
			this.number.setHTML( (this.items.length == 1) ? '' : 'Afiseaza ' + (this.activeItem+1) + ' din ' + this.items.length );
